...
export const getUniqueYears = async (includeHidden?: boolean) =>
  safelyQuery(() => (includeHidden
    ? sql`
      SELECT
...
export const getUniqueFilms = async (includeHidden?: boolean) =>
  safelyQuery(() => (includeHidden
    ? sql`
...
export const getUniqueFocalLengths = async (includeHidden?: boolean) =>
  safelyQuery(() => (includeHidden
    ? sql`
